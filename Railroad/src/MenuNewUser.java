 ...
 * @author alepage
 */
public class MenuNewUser extends javax.swing.JFrame {
    private String joueur;
    /**
     * Creates new form Menu
     */
    public MenuNewUser(String j) {
        initComponents();
        this.joueur=j;
    ...
    private void initComponents() {
        ...
        jButton3.setText("Editeur de monde");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuNewUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new MenuNewUser().setVisible(true);
            }
        });
    }
